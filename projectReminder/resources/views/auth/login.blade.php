			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control btn-primary rounded submit ">Sign In</button>
		            </div>
		          ...
		          <p class="text-center">Not a member? <a class="text-primary" href="{{route('register')}}">Sign Up</a></p>
